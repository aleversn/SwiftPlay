    ...
    handleEvents() {
        ...
        this.tray.on("right-click", () => {
            if (this.isPlaying !== this.curDisplayPlaying) {
                ...
                this.contextMenu.getMenuItemById("play").visible =
                    !this.isPlaying;
                this.contextMenu.getMenuItemById("pause").visible =
                    this.isPlaying;
            }

            if (this.isLiked !== this.curDisplayLiked) {
                this.curDisplayLiked = this.isLiked;
                this.contextMenu.getMenuItemById("like").visible =
                    !this.isLiked;
                this.contextMenu.getMenuItemById("unlike").visible =
                    this.isLiked;
            }
