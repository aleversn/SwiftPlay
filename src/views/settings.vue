    ...
    <div class="settings-page" @click="clickOutside">
        <div class="container">
            ...
            <div v-if="isElectron" class="item">
                <div class="left">
                    <div class="title">
                        {{ $t("settings.showLibraryDefault") }}</div
                    >
                </div>
                <div class="right">
                    <fv-toggle-switch
            ...
            <div class="item">
                <div class="left">
                    <div class="title" style="transform: scaleX(-1)"
                        >🐈️ 🏳️‍🌈</div
                    >
                </div>
                <div class="right">
            ...
            <div v-if="isElectron">
                ...
                <div class="item">
                    <div class="left">
                        <div class="title">
                            {{ $t("settings.enableGlobalShortcut") }}</div
                        >
                    </div>
                    <div class="right">
                        <fv-toggle-switch
            ...
            <div class="footer">
                <p class="author"
                    >MADE BY
                    <a href="http://github.com/qier222" target="_blank"
                        >QIER222</a
                    >
                </p>
...
export default {
    ...
    computed: {
        ...
        outputDevice: {
            ...
            set(deviceId) {
                if (
                    deviceId === this.settings.outputDevice ||
                    deviceId === undefined
                )
                    return;
        ...
        showPlaylistsByAppleMusic: {
            get() {
                if (this.settings.showPlaylistsByAppleMusic === undefined)
                    return true;
        ...
        automaticallyCacheSongs: {
            get() {
                if (this.settings.automaticallyCacheSongs === undefined)
                    return false;
        ...
        enableReversedMode: {
            get() {
                if (this.settings.enableReversedMode === undefined)
                    return false;
    ...
    methods: {
        ...
        readyToRecordShortcut(id, type) {
            if (
                type === "globalShortcut" &&
                this.enableGlobalShortcut === false
            ) {
                return;
            }
...
.toggle input + label:after {
    ...
    position: absolute;
    display: block;
    box-shadow: 0 0 0 1px hsla(0, 0%, 0%, 0.02),
        0 4px 0px 0 hsla(0, 0%, 0%, 0.01), 0 4px 9px hsla(0, 0%, 0%, 0.08),
